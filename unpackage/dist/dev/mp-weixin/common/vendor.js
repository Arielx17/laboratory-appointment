...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"yangfan","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var vm = _vue.default.prototype;var _default =

{
  getSwiper: function getSwiper() {return vm.$u.get('/api/News/GetIndexPic?columnId=18');},

  aboutUs: function aboutUs() {return vm.$u.get('/api/News/Get?id=16');},

  authLogin: function authLogin(params) {return vm.$u.post('/api/Auth/LoginMiniProgram', params);},

  createUser: function createUser(params) {return vm.$u.post('/api/WxUser/Create', params);} };exports.default = _default;
